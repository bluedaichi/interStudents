...
<body>
	...
	<div id="main">
		...
		<div id="textbox">
			<s:form action="ProfileUpdateConfirmAction">
				<div id="select">
				...
				<label id="text"> <input type="text" name="userName"
					value="" placeholder="名前(漢字)" /><br /> <br /> <input type="text"
					name="furigana" value="" placeholder="ふりがな" /><br /> <br /> <input
					type="text" name="birthplace" value="" placeholder="出身地" /><br />
					<br /> <input type="text" name="userHobby" value=""
					placeholder="趣味" /><br /> <br /> <input type="text"
					name="userComment" value="" placeholder="一言コメント" /><br /> <br />
				</label>
				<div id="btn-right">
